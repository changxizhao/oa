...
<body scroll="no">
	<%
		...
		String iframeUrl = "zczjhz_sskf_iframe.jsp?czny=" + czny + "&sskf=" + sskf;
	%>


	
		<form action="zczjhz_sskf.jsp" method="post" id="weaver" name="weaver">
		...
		<div class="advancedSearchDiv" id="advancedSearchDiv">
			<wea:layout type="fourCol">
				<wea:group context="查询条件">
					...
					<wea:item>
						<brow:browser name="sskf" viewType="0" hasBrowser="true"
							hasAdd="false"
							browserUrl='/systeminfo/BrowserMain.jsp?url=/interface/MultiCommonBrowser.jsp?type=browser.kfnew'
	...
	<script type="text/javascript">
		...
		function exportCheckedYear(){
			...
			window.open("/change/report/zctz/zczjhz_sskf_export.jsp?czny=" + year)
		}
